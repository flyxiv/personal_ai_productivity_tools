"""This script is used to get the daily AI paper from the Gemini API and send it to the email.
...
def get_daily_ai_papers():
    ...
    send_email(config['email'], f"[{date}] <Daily AI Paper> {response_json['title']}", response_json['html_content'])
